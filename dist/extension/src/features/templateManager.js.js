...
import { SK_TEMPLATES } from "/src/core/constants.js.js";
import { showToast } from "/src/ui/toast.js.js";
import { idbSave, idbLoad, idbDelete } from "/src/api/storage/idb.js.js";
...
import { storage as storageManager } from "/src/api/storage/index.js.js";
...
async function renderSharedTemplates(wrapper, onSelectTemplate, currentActiveName) {
    const { FirebaseService } = await import("/src/api/firebaseService.js.js");
