...
import { renderTemplateManager, saveLocalTemplate } from "/src/features/templateManager.js.js";
import { initFieldsManager, loadSavedData } from "/src/features/fieldsManager.js.js";
import { LOCAL_KEY_SIZE, LOCAL_KEY_OPENED, LOCAL_KEY_POS, SK_CALC_MAP, SK_HOTKEYS, APP_VERSION, LOCAL_KEY_PINNED } from "/src/core/constants.js.js";
import { DEFAULT_CALC_MAP, DEFAULT_HOTKEYS } from "/src/core/defaults.js.js";
import { exportConfig } from "/src/features/configManager.js.js";
import { Storage } from "/src/utils/storage.js.js";
import { exportFullBackup, importFullBackup, getInternalBackups, restoreInternalBackup } from "/src/utils/backupHelper.js.js";
import { startRecording, getHotkeyString } from "/src/features/hotkeys.js.js";
import { showToast } from "/src/ui/toast.js.js";
import { testGeminiConnection } from "/src/api/gemini.js.js";
import { initCloudSyncUI } from "/src/ui/components/CloudSyncUI.js.js";
import { RemoteConfig } from "/src/api/remoteConfig.js.js";
import { generateVNPTMockData } from "/src/features/mockDataGenerator.js.js";
...
export function initWidget() {
    ...
    if (geminiKeyInput && geminiModelSelect) {
        import("/src/core/constants.js.js").then(({ SK_GEMINI_KEY, SK_GEMINI_MODEL }) => {
    ...
    */
    ...
    // --- Token Tracker UI ---
    import("/src/utils/tokenTracker.js.js").then(({ TokenTracker }) => {
