 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dm="firebase-heartbeat-database",fm=1,Sr="firebase-heartbeat-store";let Po=null;function rl(){return Po||(Po=Rg(dm,fm,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Sr)}catch(t){console.warn(t)}}}}).catch(n=>{throw Lt.create("idb-open",{originalErrorMessage:n.message})})),Po}async function pm(n){try{const t=(await rl()).transaction(Sr),r=await t.objectStore(Sr).get(sl(n));return await t.done,r}catch(e){if(e instanceof gt)mt.warn(e.message);else{const t=Lt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});mt.warn(t.message)}}}async function il(n,e){try{const r=(await rl()).transaction(Sr,"readwrite");await r.objectStore(Sr).put(e,sl(n)),await r.done}catch(t){if(t instanceof gt)mt.warn(t.message);else{const r=Lt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});mt.warn(r.message)}}}function sl(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Vt(Em,Tm,"app");function cl(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Im=cl,ll=new Er("auth","Firebase",cl());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cr{constructor(e,t){this.shortDelay=e,this.longDelay=t,_t(t>e,"Short delay should be less than long delay!"),this.isMobile=Jp()||ng()}get(){return Sm()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pr(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof gt&&Fm(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function Fm({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hy(n,e){return kr(n,"POST","/v1/accounts:signInWithPassword",Ot(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dy(n,e){return kr(n,"POST","/v1/accounts:signInWithEmailLink",Ot(n,e))}async function fy(n,e){return kr(n,"POST","/v1/accounts:signInWithEmailLink",Ot(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $n(n,e){return kr(n,"POST","/v1/accounts:signInWithIdp",Ot(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gy(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function my(n){const e=Ir(xr(n)).link,t=e?Ir(xr(e)).deep_link_id:null,r=Ir(xr(n)).deep_link_id;return(r?Ir(xr(r)).link:null)||r||t||e||n}class qo{constructor(e){const t=Ir(xr(e)),r=t.apiKey??null,i=t.oobCode??null,s=gy(t.mode??null);z(r&&i&&s,"argument-error"),this.apiKey=r,this.operation=s,this.code=i,this.continueUrl=t.continueUrl??null,this.languageCode=t.lang??null,this.tenantId=t.tenantId??null}static parseLink(e){const t=my(e);try{return new qo(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hn{constructor(){this.providerId=Hn.PROVIDER_ID}static credential(e,t){return Nr._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=qo.parseLink(t);return z(r,"argument-error"),Nr._fromEmailAndCode(e,r.code,r.tenantId)}}Hn.PROVIDER_ID="password",Hn.EMAIL_PASSWORD_SIGN_IN_METHOD="password",Hn.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dr extends Ml{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ut extends Dr{constructor(){super("facebook.com")}static credential(e){return pn._fromParams({providerId:Ut.PROVIDER_ID,signInMethod:Ut.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Ut.credentialFromTaggedObject(e)}static credentialFromError(e){return Ut.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Ut.credential(e.oauthAccessToken)}catch{return null}}}Ut.FACEBOOK_SIGN_IN_METHOD="facebook.com",Ut.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bt extends Dr{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return pn._fromParams({providerId:Bt.PROVIDER_ID,signInMethod:Bt.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return Bt.credentialFromTaggedObject(e)}static credentialFromError(e){return Bt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return Bt.credential(t,r)}catch{return null}}}Bt.GOOGLE_SIGN_IN_METHOD="google.com",Bt.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yy(n,e){return kr(n,"POST","/v1/accounts:signUp",Ot(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hv=new Cr(5e3,15e3),dv="__/auth/iframe",fv="emulator/auth/iframe",pv={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},gv=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function mv(n){const e=n.config;z(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Lo(e,fv):`https://${n.config.authDomain}/${dv}`,r={apiKey:e.apiKey,appName:n.name,v:Un},i=gv.get(n.config.apiHost);i&&(r.eid=i);const s=n._getFrameworks();return s.length&&(r.fw=s.join(",")),`${t}?${Tr(r).slice(1)}`}async function yv(n){const e=await uv(n),t=rt().gapi;return z(t,n,"internal-error"),e.open({where:document.body,url:mv(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:pv,dontclear:!0},r=>new Promise(async(i,s)=>{await r.restyle({setHideOnLeave:!1});const a=nt(n,"network-request-failed"),c=rt().setTimeout(()=>{s(a)},hv.get());function l(){rt().clearTimeout(c),i(r)}r.ping(l).then(l,()=>{s(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Ht,cu;(function(){var n;/** @license
   ...
   Copyright The Closure Library Authors.
   SPDX-License-Identifier: Apache-2.0
  */function e(v,m){function _(){}_.prototype=m.prototype,v.F=m.prototype,v.prototype=new _,v.prototype.constructor=v,v.D=function(E,T,S){for(var b=Array(arguments.length-2),te=2;te<arguments.length;te++)b[te-2]=arguments[te];return m.prototype[T].apply(E,b)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,t),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(v,m,_){_||(_=0);const E=Array(16);if(typeof m=="string")for(var T=0;T<16;++T)E[T]=m.charCodeAt(_++)|m.charCodeAt(_++)<<8|m.charCodeAt(_++)<<16|m.charCodeAt(_++)<<24;else for(T=0;T<16;++T)E[T]=m[_++]|m[_++]<<8|m[_++]<<16|m[_++]<<24;m=v.g[0],_=v.g[1],T=v.g[2];let S=v.g[3],b;b=m+(S^_&(T^S))+E[0]+3614090360&4294967295,m=_+(b<<7&4294967295|b>>>25),b=S+(T^m&(_^T))+E[1]+3905402710&4294967295,S=m+(b<<12&4294967295|b>>>20),b=T+(_^S&(m^_))+E[2]+606105819&4294967295,T=S+(b<<17&4294967295|b>>>15),b=_+(m^T&(S^m))+E[3]+3250441966&4294967295,_=T+(b<<22&4294967295|b>>>10),b=m+(S^_&(T^S))+E[4]+4118548399&4294967295,m=_+(b<<7&4294967295|b>>>25),b=S+(T^m&(_^T))+E[5]+1200080426&4294967295,S=m+(b<<12&4294967295|b>>>20),b=T+(_^S&(m^_))+E[6]+2821735955&4294967295,T=S+(b<<17&4294967295|b>>>15),b=_+(m^T&(S^m))+E[7]+4249261313&4294967295,_=T+(b<<22&4294967295|b>>>10),b=m+(S^_&(T^S))+E[8]+1770035416&4294967295,m=_+(b<<7&4294967295|b>>>25),b=S+(T^m&(_^T))+E[9]+2336552879&4294967295,S=m+(b<<12&4294967295|b>>>20),b=T+(_^S&(m^_))+E[10]+4294925233&4294967295,T=S+(b<<17&4294967295|b>>>15),b=_+(m^T&(S^m))+E[11]+2304563134&4294967295,_=T+(b<<22&4294967295|b>>>10),b=m+(S^_&(T^S))+E[12]+1804603682&4294967295,m=_+(b<<7&4294967295|b>>>25),b=S+(T^m&(_^T))+E[13]+4254626195&4294967295,S=m+(b<<12&4294967295|b>>>20),b=T+(_^S&(m^_))+E[14]+2792965006&4294967295,T=S+(b<<17&4294967295|b>>>15),b=_+(m^T&(S^m))+E[15]+1236535329&4294967295,_=T+(b<<22&4294967295|b>>>10),b=m+(T^S&(_^T))+E[1]+4129170786&4294967295,m=_+(b<<5&4294967295|b>>>27),b=S+(_^T&(m^_))+E[6]+3225465664&4294967295,S=m+(b<<9&4294967295|b>>>23),b=T+(m^_&(S^m))+E[11]+643717713&4294967295,T=S+(b<<14&4294967295|b>>>18),b=_+(S^m&(T^S))+E[0]+3921069994&4294967295,_=T+(b<<20&4294967295|b>>>12),b=m+(T^S&(_^T))+E[5]+3593408605&4294967295,m=_+(b<<5&4294967295|b>>>27),b=S+(_^T&(m^_))+E[10]+38016083&4294967295,S=m+(b<<9&4294967295|b>>>23),b=T+(m^_&(S^m))+E[15]+3634488961&4294967295,T=S+(b<<14&4294967295|b>>>18),b=_+(S^m&(T^S))+E[4]+3889429448&4294967295,_=T+(b<<20&4294967295|b>>>12),b=m+(T^S&(_^T))+E[9]+568446438&4294967295,m=_+(b<<5&4294967295|b>>>27),b=S+(_^T&(m^_))+E[14]+3275163606&4294967295,S=m+(b<<9&4294967295|b>>>23),b=T+(m^_&(S^m))+E[3]+4107603335&4294967295,T=S+(b<<14&4294967295|b>>>18),b=_+(S^m&(T^S))+E[8]+1163531501&4294967295,_=T+(b<<20&4294967295|b>>>12),b=m+(T^S&(_^T))+E[13]+2850285829&4294967295,m=_+(b<<5&4294967295|b>>>27),b=S+(_^T&(m^_))+E[2]+4243563512&4294967295,S=m+(b<<9&4294967295|b>>>23),b=T+(m^_&(S^m))+E[7]+1735328473&4294967295,T=S+(b<<14&4294967295|b>>>18),b=_+(S^m&(T^S))+E[12]+2368359562&4294967295,_=T+(b<<20&4294967295|b>>>12),b=m+(_^T^S)+E[5]+4294588738&4294967295,m=_+(b<<4&4294967295|b>>>28),b=S+(m^_^T)+E[8]+2272392833&4294967295,S=m+(b<<11&4294967295|b>>>21),b=T+(S^m^_)+E[11]+1839030562&4294967295,T=S+(b<<16&4294967295|b>>>16),b=_+(T^S^m)+E[14]+4259657740&4294967295,_=T+(b<<23&4294967295|b>>>9),b=m+(_^T^S)+E[1]+2763975236&4294967295,m=_+(b<<4&4294967295|b>>>28),b=S+(m^_^T)+E[4]+1272893353&4294967295,S=m+(b<<11&4294967295|b>>>21),b=T+(S^m^_)+E[7]+4139469664&4294967295,T=S+(b<<16&4294967295|b>>>16),b=_+(T^S^m)+E[10]+3200236656&4294967295,_=T+(b<<23&4294967295|b>>>9),b=m+(_^T^S)+E[13]+681279174&4294967295,m=_+(b<<4&4294967295|b>>>28),b=S+(m^_^T)+E[0]+3936430074&4294967295,S=m+(b<<11&4294967295|b>>>21),b=T+(S^m^_)+E[3]+3572445317&4294967295,T=S+(b<<16&4294967295|b>>>16),b=_+(T^S^m)+E[6]+76029189&4294967295,_=T+(b<<23&4294967295|b>>>9),b=m+(_^T^S)+E[9]+3654602809&4294967295,m=_+(b<<4&4294967295|b>>>28),b=S+(m^_^T)+E[12]+3873151461&4294967295,S=m+(b<<11&4294967295|b>>>21),b=T+(S^m^_)+E[15]+530742520&4294967295,T=S+(b<<16&4294967295|b>>>16),b=_+(T^S^m)+E[2]+3299628645&4294967295,_=T+(b<<23&4294967295|b>>>9),b=m+(T^(_|~S))+E[0]+4096336452&4294967295,m=_+(b<<6&4294967295|b>>>26),b=S+(_^(m|~T))+E[7]+1126891415&4294967295,S=m+(b<<10&4294967295|b>>>22),b=T+(m^(S|~_))+E[14]+2878612391&4294967295,T=S+(b<<15&4294967295|b>>>17),b=_+(S^(T|~m))+E[5]+4237533241&4294967295,_=T+(b<<21&4294967295|b>>>11),b=m+(T^(_|~S))+E[12]+1700485571&4294967295,m=_+(b<<6&4294967295|b>>>26),b=S+(_^(m|~T))+E[3]+2399980690&4294967295,S=m+(b<<10&4294967295|b>>>22),b=T+(m^(S|~_))+E[10]+4293915773&4294967295,T=S+(b<<15&4294967295|b>>>17),b=_+(S^(T|~m))+E[1]+2240044497&4294967295,_=T+(b<<21&4294967295|b>>>11),b=m+(T^(_|~S))+E[8]+1873313359&4294967295,m=_+(b<<6&4294967295|b>>>26),b=S+(_^(m|~T))+E[15]+4264355552&4294967295,S=m+(b<<10&4294967295|b>>>22),b=T+(m^(S|~_))+E[6]+2734768916&4294967295,T=S+(b<<15&4294967295|b>>>17),b=_+(S^(T|~m))+E[13]+1309151649&4294967295,_=T+(b<<21&4294967295|b>>>11),b=m+(T^(_|~S))+E[4]+4149444226&4294967295,m=_+(b<<6&4294967295|b>>>26),b=S+(_^(m|~T))+E[11]+3174756917&4294967295,S=m+(b<<10&4294967295|b>>>22),b=T+(m^(S|~_))+E[2]+718787259&4294967295,T=S+(b<<15&4294967295|b>>>17),b=_+(S^(T|~m))+E[9]+3951481745&4294967295,v.g[0]=v.g[0]+m&4294967295,v.g[1]=v.g[1]+(T+(b<<21&4294967295|b>>>11))&4294967295,v.g[2]=v.g[2]+T&4294967295,v.g[3]=v.g[3]+S&4294967295}r.prototype.v=function(v,m){m===void 0&&(m=v.length);const _=m-this.blockSize,E=this.C;let T=this.h,S=0;for(;S<m;){if(T==0)for(;S<=_;)i(this,v,S),S+=this.blockSize;if(typeof v=="string"){for(;S<m;)if(E[T++]=v.charCodeAt(S++),T==this.blockSize){i(this,E),T=0;break}}else for(;S<m;)if(E[T++]=v[S++],T==this.blockSize){i(this,E),T=0;break}}this.h=T,this.o+=m},r.prototype.A=function(){var v=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);v[0]=128;for(var m=1;m<v.length-8;++m)v[m]=0;m=this.o*8;for(var _=v.length-8;_<v.length;++_)v[_]=m&255,m/=256;for(this.v(v),v=Array(16),m=0,_=0;_<4;++_)for(let E=0;E<32;E+=8)v[m++]=this.g[_]>>>E&255;return v};function s(v,m){var _=c;return Object.prototype.hasOwnProperty.call(_,v)?_[v]:_[v]=m(v)}function a(v,m){this.h=m;const _=[];let E=!0;for(let T=v.length-1;T>=0;T--){const S=v[T]|0;E&&S==m||(_[T]=S,E=!1)}this.g=_}var c={};function l(v){return-128<=v&&v<128?s(v,function(m){return new a([m|0],m<0?-1:0)}):new a([v|0],v<0?-1:0)}function u(v){if(isNaN(v)||!isFinite(v))return p;if(v<0)return x(u(-v));const m=[];let _=1;for(let E=0;v>=_;E++)m[E]=v/_|0,_*=4294967296;return new a(m,0)}function d(v,m){if(v.length==0)throw Error("number format error: empty string");if(m=m||10,m<2||36<m)throw Error("radix out of range: "+m);if(v.charAt(0)=="-")return x(d(v.substring(1),m));if(v.indexOf("-")>=0)throw Error('number format error: interior "-" character');const _=u(Math.pow(m,8));let E=p;for(let S=0;S<v.length;S+=8){var T=Math.min(8,v.length-S);const b=parseInt(v.substring(S,S+T),m);T<8?(T=u(Math.pow(m,T)),E=E.j(T).add(u(b))):(E=E.j(_),E=E.add(u(b)))}return E}var p=l(0),y=l(1),A=l(16777216);n=a.prototype,n.m=function(){if(w(this))return-x(this).m();let v=0,m=1;for(let _=0;_<this.g.length;_++){const E=this.i(_);v+=(E>=0?E:4294967296+E)*m,m*=4294967296}return v},n.toString=function(v){if(v=v||10,v<2||36<v)throw Error("radix out of range: "+v);if(I(this))return"0";if(w(this))return"-"+x(this).toString(v);const m=u(Math.pow(v,6));var _=this;let E="";for(;;){const T=O(_,m).g;_=C(_,T.j(m));let S=((_.g.length>0?_.g[0]:_.h)>>>0).toString(v);if(_=T,I(_))return S+E;for(;S.length<6;)S="0"+S;E=S+E}},n.i=function(v){return v<0?0:v<this.g.length?this.g[v]:this.h};function I(v){if(v.h!=0)return!1;for(let m=0;m<v.g.length;m++)if(v.g[m]!=0)return!1;return!0}function w(v){return v.h==-1}n.l=function(v){return v=C(this,v),w(v)?-1:I(v)?0:1};function x(v){const m=v.g.length,_=[];for(let E=0;E<m;E++)_[E]=~v.g[E];return new a(_,~v.h).add(y)}n.abs=function(){return w(this)?x(this):this},n.add=function(v){const m=Math.max(this.g.length,v.g.length),_=[];let E=0;for(let T=0;T<=m;T++){let S=E+(this.i(T)&65535)+(v.i(T)&65535),b=(S>>>16)+(this.i(T)>>>16)+(v.i(T)>>>16);E=b>>>16,S&=65535,b&=65535,_[T]=b<<16|S}return new a(_,_[_.length-1]&-2147483648?-1:0)};function C(v,m){return v.add(x(m))}n.j=function(v){if(I(this)||I(v))return p;if(w(this))return w(v)?x(this).j(x(v)):x(x(this).j(v));if(w(v))return x(this.j(x(v)));if(this.l(A)<0&&v.l(A)<0)return u(this.m()*v.m());const m=this.g.length+v.g.length,_=[];for(var E=0;E<2*m;E++)_[E]=0;for(E=0;E<this.g.length;E++)for(let T=0;T<v.g.length;T++){const S=this.i(E)>>>16,b=this.i(E)&65535,te=v.i(T)>>>16,ye=v.i(T)&65535;_[2*E+2*T]+=b*ye,R(_,2*E+2*T),_[2*E+2*T+1]+=S*ye,R(_,2*E+2*T+1),_[2*E+2*T+1]+=b*te,R(_,2*E+2*T+1),_[2*E+2*T+2]+=S*te,R(_,2*E+2*T+2)}for(v=0;v<m;v++)_[v]=_[2*v+1]<<16|_[2*v];for(v=m;v<2*m;v++)_[v]=0;return new a(_,0)};function R(v,m){for(;(v[m]&65535)!=v[m];)v[m+1]+=v[m]>>>16,v[m]&=65535,m++}function D(v,m){this.g=v,this.h=m}function O(v,m){if(I(m))throw Error("division by zero");if(I(v))return new D(p,p);if(w(v))return m=O(x(v),m),new D(x(m.g),x(m.h));if(w(m))return m=O(v,x(m)),new D(x(m.g),m.h);if(v.g.length>30){if(w(v)||w(m))throw Error("slowDivide_ only works with positive integers.");for(var _=y,E=m;E.l(v)<=0;)_=U(_),E=U(E);var T=H(_,1),S=H(E,1);for(E=H(E,2),_=H(_,2);!I(E);){var b=S.add(E);b.l(v)<=0&&(T=T.add(_),S=b),E=H(E,1),_=H(_,1)}return m=C(v,T.j(m)),new D(T,m)}for(T=p;v.l(m)>=0;){for(_=Math.max(1,Math.floor(v.m()/m.m())),E=Math.ceil(Math.log(_)/Math.LN2),E=E<=48?1:Math.pow(2,E-48),S=u(_),b=S.j(m);w(b)||b.l(v)>0;)_-=E,S=u(_),b=S.j(m);I(S)&&(S=y),T=T.add(S),v=C(v,b)}return new D(T,v)}n.B=function(v){return O(this,v).h},n.and=function(v){const m=Math.max(this.g.length,v.g.length),_=[];for(let E=0;E<m;E++)_[E]=this.i(E)&v.i(E);return new a(_,this.h&v.h)},n.or=function(v){const m=Math.max(this.g.length,v.g.length),_=[];for(let E=0;E<m;E++)_[E]=this.i(E)|v.i(E);return new a(_,this.h|v.h)},n.xor=function(v){const m=Math.max(this.g.length,v.g.length),_=[];for(let E=0;E<m;E++)_[E]=this.i(E)^v.i(E);return new a(_,this.h^v.h)};function U(v){const m=v.g.length+1,_=[];for(let E=0;E<m;E++)_[E]=v.i(E)<<1|v.i(E-1)>>>31;return new a(_,v.h)}function H(v,m){const _=m>>5;m%=32;const E=v.g.length-_,T=[];for(let S=0;S<E;S++)T[S]=m>0?v.i(S+_)>>>m|v.i(S+_+1)<<32-m:v.i(S+_);return new a(T,v.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,cu=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.B,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=u,a.fromString=d,Ht=a}).apply(typeof au<"u"?au:typeof self<"u"?self:typeof window<"u"?window:{});var es=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var lu,Vr,uu,ts,zo,hu,du,fu;(function(){var n,e=Object.defineProperty;function t(o){o=[typeof globalThis=="object"&&globalThis,o,typeof window=="object"&&window,typeof self=="object"&&self,typeof es=="object"&&es];for(var h=0;h<o.length;++h){var f=o[h];if(f&&f.Math==Math)return f}throw Error("Cannot find global object")}var r=t(this);function i(o,h){if(h)e:{var f=r;o=o.split(".");for(var g=0;g<o.length-1;g++){var k=o[g];if(!(k in f))break e;f=f[k]}o=o[o.length-1],g=f[o],h=h(g),h!=g&&h!=null&&e(f,o,{configurable:!0,writable:!0,value:h})}}i("Symbol.dispose",function(o){return o||Symbol("Symbol.dispose")}),i("Array.prototype.values",function(o){return o||function(){return this[Symbol.iterator]()}}),i("Object.entries",function(o){return o||function(h){var f=[],g;for(g in h)Object.prototype.hasOwnProperty.call(h,g)&&f.push([g,h[g]]);return f}});/** @license

   Copyright The Closure Library Authors.
   SPDX-License-Identifier: Apache-2.0
  */var s=s||{},a=this||self;function c(o){var h=typeof o;return h=="object"&&o!=null||h=="function"}function l(o,h,f){return o.call.apply(o.bind,arguments)}function u(o,h,f){return u=l,u.apply(null,arguments)}function d(o,h){var f=Array.prototype.slice.call(arguments,1);return function(){var g=f.slice();return g.push.apply(g,arguments),o.apply(this,g)}}function p(o,h){function f(){}f.prototype=h.prototype,o.Z=h.prototype,o.prototype=new f,o.prototype.constructor=o,o.Ob=function(g,k,P){for(var B=Array(arguments.length-2),Y=2;Y<arguments.length;Y++)B[Y-2]=arguments[Y];return h.prototype[k].apply(g,B)}}var y=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?o=>o&&AsyncContext.Snapshot.wrap(o):o=>o;function A(o){const h=o.length;if(h>0){const f=Array(h);for(let g=0;g<h;g++)f[g]=o[g];return f}return[]}function I(o,h){for(let g=1;g<arguments.length;g++){const k=arguments[g];var f=typeof k;if(f=f!="object"?f:k?Array.isArray(k)?"array":f:"null",f=="array"||f=="object"&&typeof k.length=="number"){f=o.length||0;const P=k.length||0;o.length=f+P;for(let B=0;B<P;B++)o[f+B]=k[B]}else o.push(k)}}class w{constructor(h,f){this.i=h,this.j=f,this.h=0,this.g=null}get(){let h;return this.h>0?(this.h--,h=this.g,this.g=h.next,h.next=null):h=this.i(),h}}function x(o){a.setTimeout(()=>{throw o},0)}function C(){var o=v;let h=null;return o.g&&(h=o.g,o.g=o.g.next,o.g||(o.h=null),h.next=null),h}class R{constructor(){this.h=this.g=null}add(h,f){const g=D.get();g.set(h,f),this.h?this.h.next=g:this.g=g,this.h=g}}var D=new w(()=>new O,o=>o.reset());class O{constructor(){this.next=this.g=this.h=null}set(h,f){this.h=h,this.g=f,this.next=null}reset(){this.next=this.g=this.h=null}}let U,H=!1,v=new R,m=()=>{const o=Promise.resolve(void 0);U=()=>{o.then(_)}};function _(){for(var o;o=C();){try{o.h.call(o.g)}catch(f){x(f)}var h=D;h.j(o),h.h<100&&(h.h++,o.next=h.g,h.g=o)}H=!1}function E(){this.u=this.u,this.C=this.C}E.prototype.u=!1,E.prototype.dispose=function(){this.u||(this.u=!0,this.N())},E.prototype[Symbol.dispose]=function(){this.dispose()},E.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function T(o,h){this.type=o,this.g=this.target=h,this.defaultPrevented=!1}T.prototype.h=function(){this.defaultPrevented=!0};var S=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var o=!1,h=Object.defineProperty({},"passive",{get:function(){o=!0}});try{const f=()=>{};a.addEventListener("test",f,h),a.removeEventListener("test",f,h)}catch{}return o}();function b(o){return/^[\s\xa0]*$/.test(o)}function te(o,h){T.call(this,o?o.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,o&&this.init(o,h)}p(te,T),te.prototype.init=function(o,h){const f=this.type=o.type,g=o.changedTouches&&o.changedTouches.length?o.changedTouches[0]:null;this.target=o.target||o.srcElement,this.g=h,h=o.relatedTarget,h||(f=="mouseover"?h=o.fromElement:f=="mouseout"&&(h=o.toElement)),this.relatedTarget=h,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=o.clientX!==void 0?o.clientX:o.pageX,this.clientY=o.clientY!==void 0?o.clientY:o.pageY,this.screenX=o.screenX||0,this.screenY=o.screenY||0),this.button=o.button,this.key=o.key||"",this.ctrlKey=o.ctrlKey,this.altKey=o.altKey,this.shiftKey=o.shiftKey,this.metaKey=o.metaKey,this.pointerId=o.pointerId||0,this.pointerType=o.pointerType,this.state=o.state,this.i=o,o.defaultPrevented&&te.Z.h.call(this)},te.prototype.h=function(){te.Z.h.call(this);const o=this.i;o.preventDefault?o.preventDefault():o.returnValue=!1};var ye="closure_listenable_"+(Math.random()*1e6|0),Zt=0;function He(o,h,f,g,k){this.listener=o,this.proxy=null,this.src=h,this.type=f,this.capture=!!g,this.ha=k,this.key=++Zt,this.da=this.fa=!1}function qe(o){o.da=!0,o.listener=null,o.proxy=null,o.src=null,o.ha=null}function De(o,h,f){for(const g in o)h.call(f,o[g],g,o)}function LT(o,h){for(const f in o)h.call(void 0,o[f],f,o)}function Df(o){const h={};for(const f in o)h[f]=o[f];return h}const Lf="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Vf(o,h){let f,g;for(let k=1;k<arguments.length;k++){g=arguments[k];for(f in g)o[f]=g[f];for(let P=0;P<Lf.length;P++)f=Lf[P],Object.prototype.hasOwnProperty.call(g,f)&&(o[f]=g[f])}}function ro(o){this.src=o,this.g={},this.h=0}ro.prototype.add=function(o,h,f,g,k){const P=o.toString();o=this.g[P],o||(o=this.g[P]=[],this.h++);const B=pc(o,h,g,k);return B>-1?(h=o[B],f||(h.fa=!1)):(h=new He(h,this.src,P,!!g,k),h.fa=f,o.push(h)),h};function fc(o,h){const f=h.type;if(f in o.g){var g=o.g[f],k=Array.prototype.indexOf.call(g,h,void 0),P;(P=k>=0)&&Array.prototype.splice.call(g,k,1),P&&(qe(h),o.g[f].length==0&&(delete o.g[f],o.h--))}}function pc(o,h,f,g){for(let k=0;k<o.length;++k){const P=o[k];if(!P.da&&P.listener==h&&P.capture==!!f&&P.ha==g)return k}return-1}var gc="closure_lm_"+(Math.random()*1e6|0),mc={};function Of(o,h,f,g,k){if(Array.isArray(h)){for(let P=0;P<h.length;P++)Of(o,h[P],f,g,k);return null}return f=Uf(f),o&&o[ye]?o.J(h,f,c(g)?!!g.capture:!1,k):VT(o,h,f,!1,g,k)}function VT(o,h,f,g,k,P){if(!h)throw Error("Invalid event type");const B=c(k)?!!k.capture:!!k;let Y=vc(o);if(Y||(o[gc]=Y=new ro(o)),f=Y.add(h,f,g,B,P),f.proxy)return f;if(g=OT(),f.proxy=g,g.src=o,g.listener=f,o.addEventListener)S||(k=B),k===void 0&&(k=!1),o.addEventListener(h.toString(),g,k);else if(o.attachEvent)o.attachEvent(Ff(h.toString()),g);else if(o.addListener&&o.removeListener)o.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return f}function OT(){function o(f){return h.call(o.src,o.listener,f)}const h=MT;return o}function Mf(o,h,f,g,k){if(Array.isArray(h))for(var P=0;P<h.length;P++)Mf(o,h[P],f,g,k);else g=c(g)?!!g.capture:!!g,f=Uf(f),o&&o[ye]?(o=o.i,P=String(h).toString(),P in o.g&&(h=o.g[P],f=pc(h,f,g,k),f>-1&&(qe(h[f]),Array.prototype.splice.call(h,f,1),h.length==0&&(delete o.g[P],o.h--)))):o&&(o=vc(o))&&(h=o.g[h.toString()],o=-1,h&&(o=pc(h,f,g,k)),(f=o>-1?h[o]:null)&&yc(f))}function yc(o){if(typeof o!="number"&&o&&!o.da){var h=o.src;if(h&&h[ye])fc(h.i,o);else{var f=o.type,g=o.proxy;h.removeEventListener?h.removeEventListener(f,g,o.capture):h.detachEvent?h.detachEvent(Ff(f),g):h.addListener&&h.removeListener&&h.removeListener(g),(f=vc(h))?(fc(f,o),f.h==0&&(f.src=null,h[gc]=null)):qe(o)}}}function Ff(o){return o in mc?mc[o]:mc[o]="on"+o}function MT(o,h){if(o.da)o=!0;else{h=new te(h,this);const f=o.listener,g=o.ha||o.src;o.fa&&yc(o),o=f.call(g,h)}return o}function vc(o){return o=o[gc],o instanceof ro?o:null}var _c="__closure_events_fn_"+(Math.random()*1e9>>>0);function Uf(o){return typeof o=="function"?o:(o[_c]||(o[_c]=function(h){return o.handleEvent(h)}),o[_c])}function Pe(){E.call(this),this.i=new ro(this),this.M=this,this.G=null}p(Pe,E),Pe.prototype[ye]=!0,Pe.prototype.removeEventListener=function(o,h,f,g){Mf(this,o,h,f,g)};function Le(o,h){var f,g=o.G;if(g)for(f=[];g;g=g.G)f.push(g);if(o=o.M,g=h.type||h,typeof h=="string")h=new T(h,o);else if(h instanceof T)h.target=h.target||o;else{var k=h;h=new T(g,o),Vf(h,k)}k=!0;let P,B;if(f)for(B=f.length-1;B>=0;B--)P=h.g=f[B],k=io(P,g,!0,h)&&k;if(P=h.g=o,k=io(P,g,!0,h)&&k,k=io(P,g,!1,h)&&k,f)for(B=0;B<f.length;B++)P=h.g=f[B],k=io(P,g,!1,h)&&k}Pe.prototype.N=function(){if(Pe.Z.N.call(this),this.i){var o=this.i;for(const h in o.g){const f=o.g[h];for(let g=0;g<f.length;g++)qe(f[g]);delete o.g[h],o.h--}}this.G=null},Pe.prototype.J=function(o,h,f,g){return this.i.add(String(o),h,!1,f,g)},Pe.prototype.K=function(o,h,f,g){return this.i.add(String(o),h,!0,f,g)};function io(o,h,f,g){if(h=o.i.g[String(h)],!h)return!0;h=h.concat();let k=!0;for(let P=0;P<h.length;++P){const B=h[P];if(B&&!B.da&&B.capture==f){const Y=B.listener,ve=B.ha||B.src;B.fa&&fc(o.i,B),k=Y.call(ve,g)!==!1&&k}}return k&&!g.defaultPrevented}function FT(o,h){if(typeof o!="function")if(o&&typeof o.handleEvent=="function")o=u(o.handleEvent,o);else throw Error("Invalid listener argument");return Number(h)>2147483647?-1:a.setTimeout(o,h||0)}function Bf(o){o.g=FT(()=>{o.g=null,o.i&&(o.i=!1,Bf(o))},o.l);const h=o.h;o.h=null,o.m.apply(null,h)}class UT extends E{constructor(h,f){super(),this.m=h,this.l=f,this.h=null,this.i=!1,this.g=null}j(h){this.h=arguments,this.g?this.i=!0:Bf(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function hi(o){E.call(this),this.h=o,this.g={}}p(hi,E);var qf=[];function $f(o){De(o.g,function(h,f){this.g.hasOwnProperty(f)&&yc(h)},o),o.g={}}hi.prototype.N=function(){hi.Z.N.call(this),$f(this)},hi.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var bc=a.JSON.stringify,BT=a.JSON.parse,qT=class{stringify(o){return a.JSON.stringify(o,void 0)}parse(o){return a.JSON.parse(o,void 0)}};function Hf(){}function Kf(){}var di={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function wc(){T.call(this,"d")}p(wc,T);function Ec(){T.call(this,"c")}p(Ec,T);var Cn={},jf=null;function so(){return jf=jf||new Pe}Cn.Ia="serverreachability";function zf(o){T.call(this,Cn.Ia,o)}p(zf,T);function fi(o){const h=so();Le(h,new zf(h))}Cn.STAT_EVENT="statevent";function Gf(o,h){T.call(this,Cn.STAT_EVENT,o),this.stat=h}p(Gf,T);function Ve(o){const h=so();Le(h,new Gf(h,o))}Cn.Ja="timingevent";function Wf(o,h){T.call(this,Cn.Ja,o),this.size=h}p(Wf,T);function pi(o,h){if(typeof o!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){o()},h)}function gi(){this.g=!0}gi.prototype.ua=function(){this.g=!1};function $T(o,h,f,g,k,P){o.info(function(){if(o.g)if(P){var B="",Y=P.split("&");for(let re=0;re<Y.length;re++){var ve=Y[re].split("=");if(ve.length>1){const we=ve[0];ve=ve[1];const ft=we.split("_");B=ft.length>=2&&ft[1]=="type"?B+(we+"="+ve+"&"):B+(we+"=redacted&")}}}else B=null;else B=P;return"XMLHTTP REQ ("+g+") [attempt "+k+"]: "+h+`
`+f+`
`+B})}function HT(o,h,f,g,k,P,B){o.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+k+"]: "+h+`
`+f+`
`+P+" "+B})}function pr(o,h,f,g){o.info(function(){return"XMLHTTP TEXT ("+h+"): "+jT(o,f)+(g?" "+g:"")})}function KT(o,h){o.info(function(){return"TIMEOUT: "+h})}gi.prototype.info=function(){};function jT(o,h){if(!o.g)return h;if(!h)return null;try{const P=JSON.parse(h);if(P){for(o=0;o<P.length;o++)if(Array.isArray(P[o])){var f=P[o];if(!(f.length<2)){var g=f[1];if(Array.isArray(g)&&!(g.length<1)){var k=g[0];if(k!="noop"&&k!="stop"&&k!="close")for(let B=1;B<g.length;B++)g[B]=""}}}}return bc(P)}catch{return h}}var oo={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Qf={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},Yf;function Tc(){}p(Tc,Hf),Tc.prototype.g=function(){return new XMLHttpRequest},Yf=new Tc;function mi(o){return encodeURIComponent(String(o))}function zT(o){var h=1;o=o.split(":");const f=[];for(;h>0&&o.length;)f.push(o.shift()),h--;return o.length&&f.push(o.join(":")),f}function en(o,h,f,g){this.j=o,this.i=h,this.l=f,this.S=g||1,this.V=new hi(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new Xf}function Xf(){this.i=null,this.g="",this.h=!1}var Jf={},Ic={};function xc(o,h,f){o.M=1,o.A=co(dt(h)),o.u=f,o.R=!0,Zf(o,null)}function Zf(o,h){o.F=Date.now(),ao(o),o.B=dt(o.A);var f=o.B,g=o.S;Array.isArray(g)||(g=[String(g)]),dp(f.i,"t",g),o.C=0,f=o.j.L,o.h=new Xf,o.g=Rp(o.j,f?h:null,!o.u),o.P>0&&(o.O=new UT(u(o.Y,o,o.g),o.P)),h=o.V,f=o.g,g=o.ba;var k="readystatechange";Array.isArray(k)||(k&&(qf[0]=k.toString()),k=qf);for(let P=0;P<k.length;P++){const B=Of(f,k[P],g||h.handleEvent,!1,h.h||h);if(!B)break;h.g[B.key]=B}h=o.J?Df(o.J):{},o.u?(o.v||(o.v="POST"),h["Content-Type"]="application/x-www-form-urlencoded",o.g.ea(o.B,o.v,o.u,h)):(o.v="GET",o.g.ea(o.B,o.v,null,h)),fi(),$T(o.i,o.v,o.B,o.l,o.S,o.u)}en.prototype.ba=function(o){o=o.target;const h=this.O;h&&rn(o)==3?h.j():this.Y(o)},en.prototype.Y=function(o){try{if(o==this.g)e:{const Y=rn(this.g),ve=this.g.ya(),re=this.g.ca();if(!(Y<3)&&(Y!=3||this.g&&(this.h.h||this.g.la()||_p(this.g)))){this.K||Y!=4||ve==7||(ve==8||re<=0?fi(3):fi(2)),Ac(this);var h=this.g.ca();this.X=h;var f=GT(this);if(this.o=h==200,HT(this.i,this.v,this.B,this.l,this.S,Y,h),this.o){if(this.U&&!this.L){t:{if(this.g){var g,k=this.g;if((g=k.g?k.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!b(g)){var P=g;break t}}P=null}if(o=P)pr(this.i,this.l,o,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Sc(this,o);else{this.o=!1,this.m=3,Ve(12),kn(this),yi(this);break e}}if(this.R){o=!0;let we;for(;!this.K&&this.C<f.length;)if(we=WT(this,f),we==Ic){Y==4&&(this.m=4,Ve(14),o=!1),pr(this.i,this.l,null,"[Incomplete Response]");break}else if(we==Jf){this.m=4,Ve(15),pr(this.i,this.l,f,"[Invalid Chunk]"),o=!1;break}else pr(this.i,this.l,we,null),Sc(this,we);if(ep(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Y!=4||f.length!=0||this.h.h||(this.m=1,Ve(16),o=!1),this.o=this.o&&o,!o)pr(this.i,this.l,f,"[Invalid Chunked Response]"),kn(this),yi(this);else if(f.length>0&&!this.W){this.W=!0;var B=this.j;B.g==this&&B.aa&&!B.P&&(B.j.info("Great, no buffering proxy detected. Bytes received: "+f.length),Vc(B),B.P=!0,Ve(11))}}else pr(this.i,this.l,f,null),Sc(this,f);Y==4&&kn(this),this.o&&!this.K&&(Y==4?Ap(this.j,this):(this.o=!1,ao(this)))}else c0(this.g),h==400&&f.indexOf("Unknown SID")>0?(this.m=3,Ve(12)):(this.m=0,Ve(13)),kn(this),yi(this)}}}catch{}finally{}};function GT(o){if(!ep(o))return o.g.la();const h=_p(o.g);if(h==="")return"";let f="";const g=h.length,k=rn(o.g)==4;if(!o.h.i){if(typeof TextDecoder>"u")return kn(o),yi(o),"";o.h.i=new a.TextDecoder}for(let P=0;P<g;P++)o.h.h=!0,f+=o.h.i.decode(h[P],{stream:!(k&&P==g-1)});return h.length=0,o.h.g+=f,o.C=0,o.h.g}function ep(o){return o.g?o.v=="GET"&&o.M!=2&&o.j.Aa:!1}function WT(o,h){var f=o.C,g=h.indexOf(`
`,f);return g==-1?Ic:(f=Number(h.substring(f,g)),isNaN(f)?Jf:(g+=1,g+f>h.length?Ic:(h=h.slice(g,g+f),o.C=g+f,h)))}en.prototype.cancel=function(){this.K=!0,kn(this)};function ao(o){o.T=Date.now()+o.H,tp(o,o.H)}function tp(o,h){if(o.D!=null)throw Error("WatchDog timer not null");o.D=pi(u(o.aa,o),h)}function Ac(o){o.D&&(a.clearTimeout(o.D),o.D=null)}en.prototype.aa=function(){this.D=null;const o=Date.now();o-this.T>=0?(KT(this.i,this.B),this.M!=2&&(fi(),Ve(17)),kn(this),this.m=2,yi(this)):tp(this,this.T-o)};function yi(o){o.j.I==0||o.K||Ap(o.j,o)}function kn(o){Ac(o);var h=o.O;h&&typeof h.dispose=="function"&&h.dispose(),o.O=null,$f(o.V),o.g&&(h=o.g,o.g=null,h.abort(),h.dispose())}function Sc(o,h){try{var f=o.j;if(f.I!=0&&(f.g==o||Cc(f.h,o))){if(!o.L&&Cc(f.h,o)&&f.I==3){try{var g=f.Ba.g.parse(h)}catch{g=null}if(Array.isArray(g)&&g.length==3){var k=g;if(k[0]==0){e:if(!f.v){if(f.g)if(f.g.F+3e3<o.F)po(f),ho(f);else break e;Lc(f),Ve(18)}}else f.xa=k[1],0<f.xa-f.K&&k[2]<37500&&f.F&&f.A==0&&!f.C&&(f.C=pi(u(f.Va,f),6e3));ip(f.h)<=1&&f.ta&&(f.ta=void 0)}else Pn(f,11)}else if((o.L||f.g==o)&&po(f),!b(h))for(k=f.Ba.g.parse(h),h=0;h<k.length;h++){let re=k[h];const we=re[0];if(!(we<=f.K))if(f.K=we,re=re[1],f.I==2)if(re[0]=="c"){f.M=re[1],f.ba=re[2];const ft=re[3];ft!=null&&(f.ka=ft,f.j.info("VER="+f.ka));const Nn=re[4];Nn!=null&&(f.za=Nn,f.j.info("SVER="+f.za));const sn=re[5];sn!=null&&typeof sn=="number"&&sn>0&&(g=1.5*sn,f.O=g,f.j.info("backChannelRequestTimeoutMs_="+g)),g=f;const on=o.g;if(on){const mo=on.g?on.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(mo){var P=g.h;P.g||mo.indexOf("spdy")==-1&&mo.indexOf("quic")==-1&&mo.indexOf("h2")==-1||(P.j=P.l,P.g=new Set,P.h&&(kc(P,P.h),P.h=null))}if(g.G){const Oc=on.g?on.g.getResponseHeader("X-HTTP-Session-Id"):null;Oc&&(g.wa=Oc,oe(g.J,g.G,Oc))}}f.I=3,f.l&&f.l.ra(),f.aa&&(f.T=Date.now()-o.F,f.j.info("Handshake RTT: "+f.T+"ms")),g=f;var B=o;if(g.na=kp(g,g.L?g.ba:null,g.W),B.L){sp(g.h,B);var Y=B,ve=g.O;ve&&(Y.H=ve),Y.D&&(Ac(Y),ao(Y)),g.g=B}else Ip(g);f.i.length>0&&fo(f)}else re[0]!="stop"&&re[0]!="close"||Pn(f,7);else f.I==3&&(re[0]=="stop"||re[0]=="close"?re[0]=="stop"?Pn(f,7):Dc(f):re[0]!="noop"&&f.l&&f.l.qa(re),f.A=0)}}fi(4)}catch{}}var QT=class{constructor(o,h){this.g=o,this.map=h}};function np(o){this.l=o||10,a.PerformanceNavigationTiming?(o=a.performance.getEntriesByType("navigation"),o=o.length>0&&(o[0].nextHopProtocol=="hq"||o[0].nextHopProtocol=="h2")):o=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=o?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function rp(o){return o.h?!0:o.g?o.g.size>=o.j:!1}function ip(o){return o.h?1:o.g?o.g.size:0}function Cc(o,h){return o.h?o.h==h:o.g?o.g.has(h):!1}function kc(o,h){o.g?o.g.add(h):o.h=h}function sp(o,h){o.h&&o.h==h?o.h=null:o.g&&o.g.has(h)&&o.g.delete(h)}np.prototype.cancel=function(){if(this.i=op(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const o of this.g.values())o.cancel();this.g.clear()}};function op(o){if(o.h!=null)return o.i.concat(o.h.G);if(o.g!=null&&o.g.size!==0){let h=o.i;for(const f of o.g.values())h=h.concat(f.G);return h}return A(o.i)}var ap=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function YT(o,h){if(o){o=o.split("&");for(let f=0;f<o.length;f++){const g=o[f].indexOf("=");let k,P=null;g>=0?(k=o[f].substring(0,g),P=o[f].substring(g+1)):k=o[f],h(k,P?decodeURIComponent(P.replace(/\+/g," ")):"")}}}function tn(o){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let h;o instanceof tn?(this.l=o.l,vi(this,o.j),this.o=o.o,this.g=o.g,_i(this,o.u),this.h=o.h,Rc(this,fp(o.i)),this.m=o.m):o&&(h=String(o).match(ap))?(this.l=!1,vi(this,h[1]||"",!0),this.o=bi(h[2]||""),this.g=bi(h[3]||"",!0),_i(this,h[4]),this.h=bi(h[5]||"",!0),Rc(this,h[6]||"",!0),this.m=bi(h[7]||"")):(this.l=!1,this.i=new Ei(null,this.l))}tn.prototype.toString=function(){const o=[];var h=this.j;h&&o.push(wi(h,cp,!0),":");var f=this.g;return(f||h=="file")&&(o.push("//"),(h=this.o)&&o.push(wi(h,cp,!0),"@"),o.push(mi(f).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),f=this.u,f!=null&&o.push(":",String(f))),(f=this.h)&&(this.g&&f.charAt(0)!="/"&&o.push("/"),o.push(wi(f,f.charAt(0)=="/"?ZT:JT,!0))),(f=this.i.toString())&&o.push("?",f),(f=this.m)&&o.push("#",wi(f,t0)),o.join("")},tn.prototype.resolve=function(o){const h=dt(this);let f=!!o.j;f?vi(h,o.j):f=!!o.o,f?h.o=o.o:f=!!o.g,f?h.g=o.g:f=o.u!=null;var g=o.h;if(f)_i(h,o.u);else if(f=!!o.h){if(g.charAt(0)!="/")if(this.g&&!this.h)g="/"+g;else{var k=h.h.lastIndexOf("/");k!=-1&&(g=h.h.slice(0,k+1)+g)}if(k=g,k==".."||k==".")g="";else if(k.indexOf("./")!=-1||k.indexOf("/.")!=-1){g=k.lastIndexOf("/",0)==0,k=k.split("/");const P=[];for(let B=0;B<k.length;){const Y=k[B++];Y=="."?g&&B==k.length&&P.push(""):Y==".."?((P.length>1||P.length==1&&P[0]!="")&&P.pop(),g&&B==k.length&&P.push("")):(P.push(Y),g=!0)}g=P.join("/")}else g=k}return f?h.h=g:f=o.i.toString()!=="",f?Rc(h,fp(o.i)):f=!!o.m,f&&(h.m=o.m),h};function dt(o){return new tn(o)}function vi(o,h,f){o.j=f?bi(h,!0):h,o.j&&(o.j=o.j.replace(/:$/,""))}function _i(o,h){if(h){if(h=Number(h),isNaN(h)||h<0)throw Error("Bad port number "+h);o.u=h}else o.u=null}function Rc(o,h,f){h instanceof Ei?(o.i=h,n0(o.i,o.l)):(f||(h=wi(h,e0)),o.i=new Ei(h,o.l))}function oe(o,h,f){o.i.set(h,f)}function co(o){return oe(o,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),o}function bi(o,h){return o?h?decodeURI(o.replace(/%25/g,"%2525")):decodeURIComponent(o):""}function wi(o,h,f){return typeof o=="string"?(o=encodeURI(o).replace(h,XT),f&&(o=o.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),o):null}function XT(o){return o=o.charCodeAt(0),"%"+(o>>4&15).toString(16)+(o&15).toString(16)}var cp=/[#\/\?@]/g,JT=/[#\?:]/g,ZT=/[#\?]/g,e0=/[#\?@]/g,t0=/#/g;function Ei(o,h){this.h=this.g=null,this.i=o||null,this.j=!!h}function Rn(o){o.g||(o.g=new Map,o.h=0,o.i&&YT(o.i,function(h,f){o.add(decodeURIComponent(h.replace(/\+/g," ")),f)}))}n=Ei.prototype,n.add=function(o,h){Rn(this),this.i=null,o=gr(this,o);let f=this.g.get(o);return f||this.g.set(o,f=[]),f.push(h),this.h+=1,this};function lp(o,h){Rn(o),h=gr(o,h),o.g.has(h)&&(o.i=null,o.h-=o.g.get(h).length,o.g.delete(h))}function up(o,h){return Rn(o),h=gr(o,h),o.g.has(h)}n.forEach=function(o,h){Rn(this),this.g.forEach(function(f,g){f.forEach(function(k){o.call(h,k,g,this)},this)},this)};function hp(o,h){Rn(o);let f=[];if(typeof h=="string")up(o,h)&&(f=f.concat(o.g.get(gr(o,h))));else for(o=Array.from(o.g.values()),h=0;h<o.length;h++)f=f.concat(o[h]);return f}n.set=function(o,h){return Rn(this),this.i=null,o=gr(this,o),up(this,o)&&(this.h-=this.g.get(o).length),this.g.set(o,[h]),this.h+=1,this},n.get=function(o,h){return o?(o=hp(this,o),o.length>0?String(o[0]):h):h};function dp(o,h,f){lp(o,h),f.length>0&&(o.i=null,o.g.set(gr(o,h),A(f)),o.h+=f.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const o=[],h=Array.from(this.g.keys());for(let g=0;g<h.length;g++){var f=h[g];const k=mi(f);f=hp(this,f);for(let P=0;P<f.length;P++){let B=k;f[P]!==""&&(B+="="+mi(f[P])),o.push(B)}}return this.i=o.join("&")};function fp(o){const h=new Ei;return h.i=o.i,o.g&&(h.g=new Map(o.g),h.h=o.h),h}function gr(o,h){return h=String(h),o.j&&(h=h.toLowerCase()),h}function n0(o,h){h&&!o.j&&(Rn(o),o.i=null,o.g.forEach(function(f,g){const k=g.toLowerCase();g!=k&&(lp(this,g),dp(this,k,f))},o)),o.j=h}function r0(o,h){const f=new gi;if(a.Image){const g=new Image;g.onload=d(nn,f,"TestLoadImage: loaded",!0,h,g),g.onerror=d(nn,f,"TestLoadImage: error",!1,h,g),g.onabort=d(nn,f,"TestLoadImage: abort",!1,h,g),g.ontimeout=d(nn,f,"TestLoadImage: timeout",!1,h,g),a.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=o}else h(!1)}function i0(o,h){const f=new gi,g=new AbortController,k=setTimeout(()=>{g.abort(),nn(f,"TestPingServer: timeout",!1,h)},1e4);fetch(o,{signal:g.signal}).then(P=>{clearTimeout(k),P.ok?nn(f,"TestPingServer: ok",!0,h):nn(f,"TestPingServer: server error",!1,h)}).catch(()=>{clearTimeout(k),nn(f,"TestPingServer: error",!1,h)})}function nn(o,h,f,g,k){try{k&&(k.onload=null,k.onerror=null,k.onabort=null,k.ontimeout=null),g(f)}catch{}}function s0(){this.g=new qT}function Pc(o){this.i=o.Sb||null,this.h=o.ab||!1}p(Pc,Hf),Pc.prototype.g=function(){return new lo(this.i,this.h)};function lo(o,h){Pe.call(this),this.H=o,this.o=h,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}p(lo,Pe),n=lo.prototype,n.open=function(o,h){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=o,this.D=h,this.readyState=1,Ii(this)},n.send=function(o){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const h={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};o&&(h.body=o),(this.H||a).fetch(new Request(this.D,h)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,Ti(this)),this.readyState=0},n.Pa=function(o){if(this.g&&(this.l=o,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=o.headers,this.readyState=2,Ii(this)),this.g&&(this.readyState=3,Ii(this),this.g)))if(this.responseType==="arraybuffer")o.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in o){if(this.j=o.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;pp(this)}else o.text().then(this.Oa.bind(this),this.ga.bind(this))};function pp(o){o.j.read().then(o.Ma.bind(o)).catch(o.ga.bind(o))}n.Ma=function(o){if(this.g){if(this.o&&o.value)this.response.push(o.value);else if(!this.o){var h=o.value?o.value:new Uint8Array(0);(h=this.B.decode(h,{stream:!o.done}))&&(this.response=this.responseText+=h)}o.done?Ti(this):Ii(this),this.readyState==3&&pp(this)}},n.Oa=function(o){this.g&&(this.response=this.responseText=o,Ti(this))},n.Na=function(o){this.g&&(this.response=o,Ti(this))},n.ga=function(){this.g&&Ti(this)};function Ti(o){o.readyState=4,o.l=null,o.j=null,o.B=null,Ii(o)}n.setRequestHeader=function(o,h){this.A.append(o,h)},n.getResponseHeader=function(o){return this.h&&this.h.get(o.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const o=[],h=this.h.entries();for(var f=h.next();!f.done;)f=f.value,o.push(f[0]+": "+f[1]),f=h.next();return o.join(`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ru="server_timestamp",Pu="__type__",Nu="__previous_value__",Du="__local_write_time__";function Jo(n){var t,r;return((r=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[Pu])==null?void 0:r.stringValue)===Ru}function as(n){const e=n.mapValue.fields[Nu];return Jo(e)?as(e):e}function Fr(n){const e=jt(n.mapValue.fields[Du].timestampValue);return new se(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class a_{constructor(e,t,r,i,s,a,c,l,u,d,p){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=i,this.ssl=s,this.forceLongPolling=a,this.autoDetectLongPolling=c,this.longPollingOptions=l,this.useFetchStreams=u,this.isUsingEmulator=d,this.apiKey=p}}const cs="(default)";class Ur{constructor(e,t){this.projectId=e,this.database=t||cs}static empty(){return new Ur("","")}get isDefaultDatabase(){return this.database===cs}isEqual(e){return e instanceof Ur&&e.projectId===this.projectId&&e.database===this.database}}function c_(n,e){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new q(L.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ur(n.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ze{constructor(e){this.value=e}static empty(){return new ze({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!ds(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=qr(t)}setAll(e){let t=Ee.emptyPath(),r={},i=[];e.forEach((a,c)=>{if(!t.isImmediateParentOf(c)){const l=this.getFieldsMap(t);this.applyChanges(l,r,i),r={},i=[],t=c.popLast()}a?r[c.lastSegment()]=qr(a):i.push(c.lastSegment())});const s=this.getFieldsMap(t);this.applyChanges(s,r,i)}delete(e){const t=this.field(e.popLast());ds(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return st(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let i=t.mapValue.fields[e.get(r)];ds(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=i),t=i}return t.mapValue.fields}applyChanges(e,t,r){_n(t,(i,s)=>e[i]=s);for(const i of r)delete e[i]}clone(){return new ze(qr(this.value))}}function qu(n){const e=[];return _n(n.fields,(t,r)=>{const i=new Ee([t]);if(ds(r)){const s=qu(r.mapValue).fields;if(s.length===0)e.push(i);else for(const a of s)e.push(i.child(a))}else e.push(i)}),new Je(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S_=new ae(j.comparator);function Tt(){return S_}const th=new ae(j.comparator);function Kr(...n){let e=th;for(const t of n)e=e.insert(t.key,t);return e}function nh(n){let e=th;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function wn(){return jr()}function rh(){return jr()}function jr(){return new bn(n=>n.toString(),(n,e)=>n.isEqual(e))}const C_=new ae(j.comparator),k_=new me(j.comparator);function Z(...n){let e=k_;for(const t of n)e=e.add(t);return e}const R_=new me(J);function P_(){return R_}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ys{constructor(){this._=void 0}}function D_(n,e,t){return n instanceof zr?function(i,s){const a={fields:{[Pu]:{stringValue:Ru},[Du]:{timestampValue:{seconds:i.seconds,nanos:i.nanoseconds}}}};return s&&Jo(s)&&(s=as(s)),s&&(a.fields[Nu]=s),{mapValue:a}}(t,e):n instanceof Gr?oh(n,e):n instanceof Wr?ah(n,e):function(i,s){const a=sh(i,s),c=ch(a)+ch(i.Ae);return ea(a)&&ea(i.Ae)?ih(c):la(i.serializer,c)}(n,e)}function L_(n,e,t){return n instanceof Gr?oh(n,e):n instanceof Wr?ah(n,e):t}function sh(n,e){return n instanceof vs?function(r){return ea(r)||function(s){return!!s&&"doubleValue"in s}(r)}(e)?e:{integerValue:0}:null}class zr extends ys{}class Gr extends ys{constructor(e){super(),this.elements=e}}function oh(n,e){const t=lh(e);for(const r of n.elements)t.some(i=>st(i,r))||t.push(r);return{arrayValue:{values:t}}}class Wr extends ys{constructor(e){super(),this.elements=e}}function ah(n,e){let t=lh(e);for(const r of n.elements)t=t.filter(i=>!st(i,r));return{arrayValue:{values:t}}}class vs extends ys{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function ch(n){return ue(n.integerValue||n.doubleValue)}function lh(n){return ta(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ws{constructor(e,t,r,i,s){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const i=new Map;return i.set(e,Jr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new ws(W.min(),i,new ae(J),Tt(),Z())}}class Jr{constructor(e,t,r,i,s){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Jr(r,t,Z(),Z(),Z())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eb{constructor(e,t,r,i){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=i}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next(i=>(r=i,this.remoteDocumentCache.getEntry(e,t))).next(i=>(r!==null&&Qr(r.mutation,i,Je.empty(),se.now()),i))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.getLocalViewOfDocuments(e,r,Z()).next(()=>r))}getLocalViewOfDocuments(e,t,r=Z()){const i=wn();return this.populateOverlays(e,i,t).next(()=>this.computeViews(e,t,i,r).next(s=>{let a=Kr();return s.forEach((c,l)=>{a=a.insert(c,l.overlayedDocument)}),a}))}getOverlayedDocuments(e,t){const r=wn();return this.populateOverlays(e,r,t).next(()=>this.computeViews(e,t,r,Z()))}populateOverlays(e,t,r){const i=[];return r.forEach(s=>{t.has(s)||i.push(s)}),this.documentOverlayCache.getOverlays(e,i).next(s=>{s.forEach((a,c)=>{t.set(a,c)})})}computeViews(e,t,r,i){let s=Tt();const a=jr(),c=function(){return jr()}();return t.forEach((l,u)=>{const d=r.get(u.key);i.has(u.key)&&(d===void 0||d.mutation instanceof En)?s=s.insert(u.key,u):d!==void 0?(a.set(u.key,d.mutation.getFieldMask()),Qr(d.mutation,u,d.mutation.getFieldMask(),se.now())):a.set(u.key,Je.empty())}),this.recalculateAndSaveOverlays(e,s).next(l=>(l.forEach((u,d)=>a.set(u,d)),t.forEach((u,d)=>c.set(u,new wb(d,a.get(u)??null))),c))}recalculateAndSaveOverlays(e,t){const r=jr();let i=new ae((a,c)=>a-c),s=Z();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(a=>{for(const c of a)c.keys().forEach(l=>{const u=t.get(l);if(u===null)return;let d=r.get(l)||Je.empty();d=c.applyToLocalView(u,d),r.set(l,d);const p=(i.get(c.batchId)||Z()).add(l);i=i.insert(c.batchId,p)})}).next(()=>{const a=[],c=i.getReverseIterator();for(;c.hasNext();){const l=c.getNext(),u=l.key,d=l.value,p=rh();d.forEach(y=>{if(!s.has(y)){const A=uh(t.get(y),r.get(y));A!==null&&p.set(y,A),s=s.add(y)}}),a.push(this.documentOverlayCache.saveOverlays(e,u,p))}return V.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,t,r,i){return T_(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Ju(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,i):this.getDocumentsMatchingCollectionQuery(e,t,r,i)}getNextDocuments(e,t,r,i){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,i).next(s=>{const a=i-s.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,i-s.size):V.resolve(wn());let c=Mr,l=s;return a.next(u=>V.forEach(u,(d,p)=>(c<p.largestBatchId&&(c=p.largestBatchId),s.get(d)?V.resolve():this.remoteDocumentCache.getEntry(e,d).next(y=>{l=l.insert(d,y)}))).next(()=>this.populateOverlays(e,u,s)).next(()=>this.computeViews(e,l,u,Z())).next(d=>({batchId:c,changes:nh(d)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new j(t)).next(r=>{let i=Kr();return r.isFoundDocument()&&(i=i.insert(r.key,r)),i})}getDocumentsMatchingCollectionGroupQuery(e,t,r,i){const s=t.collectionGroup;let a=Kr();return this.indexManager.getCollectionParents(e,s).next(c=>V.forEach(c,l=>{const u=function(p,y){return new $r(y,null,p.explicitOrderBy.slice(),p.filters.slice(),p.limit,p.limitType,p.startAt,p.endAt)}(t,l.child(s));return this.getDocumentsMatchingCollectionQuery(e,u,r,i).next(d=>{d.forEach((p,y)=>{a=a.insert(p,y)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(e,t,r,i){let s;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next(a=>(s=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,s,i))).next(a=>{s.forEach((l,u)=>{const d=u.getKey();a.get(d)===null&&(a=a.insert(d,Se.newInvalidDocument(d)))});let c=Kr();return a.forEach((l,u)=>{const d=s.get(l);d!==void 0&&Qr(d.mutation,u,Je.empty(),se.now()),ms(t,u)&&(c=c.insert(l,u))}),c})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce="WebChannelConnection",Zr=(n,e,t)=>{n.listen(e,r=>{try{t(r)}catch(i){setTimeout(()=>{throw i},0)}})};class nr extends jb{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!nr.c_){const e=du();Zr(e,hu.STAT_EVENT,t=>{t.stat===zo.PROXY?K(Ce,"STAT_EVENT: detected buffering proxy"):t.stat===zo.NOPROXY&&K(Ce,"STAT_EVENT: detected no buffering proxy")}),nr.c_=!0}}zo(e,t,r,i,s){const a=Ta();return new Promise((c,l)=>{const u=new lu;u.setWithCredentials(!0),u.listenOnce(uu.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case ts.NO_ERROR:const p=u.getResponseJson();K(Ce,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(p)),c(p);break;case ts.TIMEOUT:K(Ce,`RPC '${e}' ${a} timed out`),l(new q(L.DEADLINE_EXCEEDED,"Request time out"));break;case ts.HTTP_ERROR:const y=u.getStatus();if(K(Ce,`RPC '${e}' ${a} failed with status:`,y,"response text:",u.getResponseText()),y>0){let A=u.getResponseJson();Array.isArray(A)&&(A=A[0]);const I=A==null?void 0:A.error;if(I&&I.status&&I.message){const w=function(C){const R=C.toLowerCase().replace(/_/g,"-");return Object.values(L).indexOf(R)>=0?R:L.UNKNOWN}(I.status);l(new q(w,I.message))}else l(new q(L.UNKNOWN,"Server responded with status "+u.getStatus()))}else l(new q(L.UNAVAILABLE,"Connection failed."));break;default:G(9055,{l_:e,streamId:a,h_:u.getLastErrorCode(),P_:u.getLastError()})}}finally{K(Ce,`RPC '${e}' ${a} completed.`)}});const d=JSON.stringify(i);K(Ce,`RPC '${e}' ${a} sending request:`,i),u.send(t,"POST",d,r,15)})}T_(e,t,r){const i=Ta(),s=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},l=this.longPollingOptions.timeoutSeconds;l!==void 0&&(c.longPollingTimeout=Math.round(1e3*l)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Go(c.initMessageHeaders,t,r),c.encodeInitMessageHeaders=!0;const u=s.join("");K(Ce,`Creating RPC '${e}' stream ${i}: ${u}`,c);const d=a.createWebChannel(u,c);this.E_(d);let p=!1,y=!1;const A=new zb({Jo:I=>{y?K(Ce,`Not sending because RPC '${e}' stream ${i} is closed:`,I):(p||(K(Ce,`Opening RPC '${e}' stream ${i} transport.`),d.open(),p=!0),K(Ce,`RPC '${e}' stream ${i} sending:`,I),d.send(I))},Ho:()=>d.close()});return Zr(d,Vr.EventType.OPEN,()=>{y||(K(Ce,`RPC '${e}' stream ${i} transport opened.`),A.i_())}),Zr(d,Vr.EventType.CLOSE,()=>{y||(y=!0,K(Ce,`RPC '${e}' stream ${i} transport closed`),A.o_(),this.I_(d))}),Zr(d,Vr.EventType.ERROR,I=>{y||(y=!0,yn(Ce,`RPC '${e}' stream ${i} transport errored. Name:`,I.name,"Message:",I.message),A.o_(new q(L.UNAVAILABLE,"The operation could not be completed")))}),Zr(d,Vr.EventType.MESSAGE,I=>{var w;if(!y){const x=I.data[0];ne(!!x,16349);const C=x,R=(C==null?void 0:C.error)||((w=C[0])==null?void 0:w.error);if(R){K(Ce,`RPC '${e}' stream ${i} received error:`,R);const D=R.status;let O=function(v){const m=fe[v];if(m!==void 0)return mh(m)}(D),U=R.message;D==="NOT_FOUND"&&U.includes("database")&&U.includes("does not exist")&&U.includes(this.databaseId.database)&&yn(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),O===void 0&&(O=L.INTERNAL,U="Unknown error status: "+D+" with message "+R.message),y=!0,A.o_(new q(O,U)),d.close()}else K(Ce,`RPC '${e}' stream ${i} received:`,x),A.__(x)}}),nr.u_(),setTimeout(()=>{A.s_()},0),A}terminate(){this.a_.forEach(e=>e.close()),this.a_=[]}E_(e){this.a_.push(e)}I_(e){this.a_=this.a_.filter(t=>t===e)}Go(e,t,r){super.Go(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return fu()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ct{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new q(L.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new q(L.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return J(this._lat,e._lat)||J(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:ct._jsonSchemaVersion}}static fromJSON(e){if(Or(e,ct._jsonSchema))return new ct(e.latitude,e.longitude)}}ct._jsonSchemaVersion="firestore/geoPoint/1.0",ct._jsonSchema={type:he("string",ct._jsonSchemaVersion),latitude:he("number"),longitude:he("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class et{constructor(e){this._values=(e||[]).map(t=>t)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(r,i){if(r.length!==i.length)return!1;for(let s=0;s<r.length;++s)if(r[s]!==i[s])return!1;return!0}(this._values,e._values)}toJSON(){return{type:et._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(Or(e,et._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(t=>typeof t=="number"))return new et(e.vectorValues);throw new q(L.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}et._jsonSchemaVersion="firestore/vectorValue/1.0",et._jsonSchema={type:he("string",et._jsonSchemaVersion),vectorValues:he("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
Kết quả: {
  ...
  "rawFullText": "..."
    ...
    `,document.body.appendChild(i);const a=i.querySelector("#pdf-btn-cancel"),c=i.querySelector("#pdf-btn-confirm"),l=i.querySelector("#pdf-btn-reparse"),u=i.querySelector("#pdf-check-all"),d=i.querySelectorAll(".pdf-row-chk");i.querySelectorAll(".pdf-val-input");const p=i.querySelector("#pdf-raw-text-edit");u&&u.addEventListener("change",I=>{d.forEach(w=>w.checked=I.target.checked)});const y=()=>{window.removeEventListener("keydown",A),i.remove()},A=I=>{if(I.key==="Escape")y();else if(I.key==="Enter"){if(I.target&&I.target.id==="pdf-raw-text-edit")return;I.preventDefault(),c.click()}};window.addEventListener("keydown",A),a.onclick=y,l.onclick=()=>{if(r){const I=p.value;r(I)}},c.onclick=()=>{try{const I=[];i.querySelectorAll(".pdf-row-auto").forEach(x=>{const C=x.querySelector(".pdf-row-chk"),R=x.querySelector(".pdf-val-input");if(C&&C.checked&&R){const D=parseInt(C.getAttribute("data-index"));n[D]&&I.push({...n[D],value:R.value})}}),y(),t&&t(I)}catch(I){console.error("[VNPT] Lỗi khi xác nhận kết quả:",I),alert("Có lỗi xảy ra khi lưu dữ liệu. Vui lòng thử lại.")}}}const Re={name:n=>n?n.trim().toUpperCase().replace(/\s+/g," "):"",mst:n=>n?n.replace(/[^\d]/g,"").trim():"",date:(n,e,t)=>`${String(n).padStart(2,"0")}/${String(e).padStart(2,"0")}/${t}`,text:n=>n?n.trim().replace(/\s+/g," "):""};function xt(n,e){for(const t of e){const r=n.match(t);if(r&&r[1])return r[1].trim()}return null}function lT(n){if(!n)return{};const e={},t=n.replace(/\r/g,"");if(t.includes("|")){const m=t.split("|").map(_=>_.trim());if(m.length>=6){e.cmnd=Re.mst(m[0]),e.tenDaiDienn=Re.name(m[2]);const _=m[3];_&&_.length===8&&!_.includes("/")?e.ngaySinhCustomer=Re.date(_.slice(0,2),_.slice(2,4),_.slice(4)):_&&(e.ngaySinhCustomer=_),m[5]&&(e.diaChiCustomer=Re.text(m[5]));const E=m[6];return E&&E.length===8&&!E.includes("/")?e.ngayCapCustomer=Re.date(E.slice(0,2),E.slice(2,4),E.slice(4)):E&&(e.ngayCapCustomer=E),e.noiCap="Cục Cảnh sát quản lý hành chính về trật tự xã hội",e}}const i=xt(t,[/(?:Tên công ty viết bằng tiếng Việt|Tên doanh nghiệp|Tên tổ chức|Doanh nghiệp|Công ty):?\s*([\s\S]+?)(?=\n|Tên công ty|Mã số|$)/i,/Tên công ty viết bằng tiếng nước ngoài:?\s*([\s\S]+?)(?=\n|Tên công ty|$)/i,/Tên công ty viết tắt:?\s*([\s\S]+?)(?=\n|Địa chỉ|$)/i]);i&&(e.tenToChuc=Re.text(i));const a=xt(t,[/(?:Mã số doanh nghiệp|Mã số thuế):?\s*([\d\s.]{10,16})/i,/MST:?\s*([\d\s.]{10,16})/i]);a&&(e.soDkdn=Re.mst(a));let l=xt(t,[/(?:Họ và tên|Người đại diện theo pháp luật|Tên đại diện|Full name):?\s*([\s\S]+?)(?=\n|Chức danh|Chức vụ|Giới tính|Sinh ngày|Date of birth|$)/i,/Người đại diện:?\s*([\s\S]+?)(?=\n|Chức vụ|$)/i]);l&&(l=l.replace(/^(?:Họ và tên|Người đại diện theo pháp luật|Tên đại diện|Full name|[\/\s]*Full name):?\s*/i,"").replace(/^\/\s*/,""),e.tenDaiDienn=Re.name(l));const d=xt(t,[/(?:Chức danh|Chức vụ):?\s*([\s\S]+?)(?=\n|Sinh ngày|Giới tính|Quốc tịch|$)/i]);d&&(e.chucVu=Re.text(d));const p=t.match(/(?:Đăng ký|Đảng kỷ|Cấp ngày|Ngày cấp) (?:lần đầu|thay đổi):?\s*ngày\s*(\d{1,2})\s*tháng\s*(\d{1,2})\s*năm\s*(\d{4})/i);p&&(e.ngayCapSoDkdnCustomer=Re.date(p[1],p[2],p[3]));const A=xt(t,[/(?:Điện thoại|SĐT|Tel):?\s*([\d\s.-]{9,15})/i]);A&&(e.sdt=A.replace(/[\s.-]/g,"").trim());const w=xt(t,[/(?:Thư điện tử|Email):?\s*([^\s\n]+)/i]);w&&(e.emailDaiDien=w.replace(/\(a\)/g,"@").trim());const C=xt(t,[/(?:Số định danh cá nhân|Số CMND|Số CCCD|Số Hộ chiếu|Số \/ No\.):?\s*(\d[\d\s]{8,13})/i,/(?:CMND|CCCD) số:?\s*(\d[\d\s]{8,13})/i]);C&&(e.cmnd=Re.mst(C));const D=xt(t,[/Nơi cấp:?\s*([\s\S]+?)(?=\n|Ngày cấp|$)/i,/Cục trưởng Cục Cảnh sát ([\s\S]+?)(?=\n|$)/i]);D&&(e.noiCap=Re.text(D));const O=t.match(/Ngày cấp:?\s*(\d{1,2})[\/\-. ](\d{1,2})[\/\-. ](\d{4})/i);O&&(e.ngayCapCustomer=Re.date(O[1],O[2],O[3]));const U=t.match(/(?:Ngày, tháng, năm sinh|Sinh ngày|Ngày sinh):?\s*ngày\s*(\d{1,2})\s*tháng\s*(\d{1,2})\s*năm\s*(\d{4})/i);if(U)e.ngaySinhCustomer=Re.date(U[1],U[2],U[3]);else{const m=t.match(/(?:Ngày sinh|Sinh ngày):?\s*(\d{1,2})[\/\-. ](\d{1,2})[\/\-. ](\d{4})/i);m&&(e.ngaySinhCustomer=Re.date(m[1],m[2],m[3]))}const v=xt(t,[/(?:Địa chỉ trụ sở chính|Địa chỉ thường trú|Nơi thường trú|Địa chỉ):?\s*([\s\S]+?)(?=\n|Điện thoại|Email|SĐT|$)/i]);return v&&(e.diaChiCustomer=Re.text(v)),e}const uT=()=>{let n="";for(const[e,t]of Object.entries(_e)){const r=e.split(",")[0].trim();vr.includes(r)&&(n+=`    "${r}": "${t}",
...
`),t}catch(n){return console.error("Lỗi khi quét màn hình:",n),""}}function yT(n,e){return new Promise((t,r)=>{if(typeof GM_xmlhttpRequest>"u"){r(new Error("GM_xmlhttpRequest không khả dụng. Hãy cài đặt trên Tampermonkey."));return}GM_xmlhttpRequest({method:"GET",url:n,responseType:"arraybuffer",onload:function(i){var s;if(i.status===200){const a=((s=i.responseHeaders.match(/content-type:\s*([^\s;]+)/i))==null?void 0:s[1])||"application/octet-stream",c=vT(i.response);t({base64:c,mimeType:a,name:e})}else r(new Error("Lỗi tải tệp: "+i.status))},onerror:function(i){r(i)}})})}function vT(n){let e="";const t=new Uint8Array(n),r=t.byteLength;for(let i=0;i<r;i++)e+=String.fromCharCode(t[i]);return window.btoa(e)}let $e=[];function Sn(n,e){if(n.innerHTML="",$e.length===0){e.style.display="flex";return}e.style.display="none",$e.forEach((t,r)=>{const i=document.createElement("div");if(i.className="ai-queue-item",t.mimeType&&t.mimeType.startsWith("image/")){const a=document.createElement("img");a.src=`data:${t.mimeType};base64,${t.base64}`,i.appendChild(a)}else{const a=document.createElement("span");a.className="file-icon",a.textContent="📄",i.appendChild(a)}const s=document.createElement("button");s.className="btn-remove-item",s.innerHTML="✖",s.onclick=a=>{a.stopPropagation(),$e.splice(r,1),Sn(n,e)},i.appendChild(s),n.appendChild(i)})}function _T(n,e,t){$e=[],t.value="",Sn(n,e)}function bT(){const n=document.getElementById("vnpt-btn-ai-mode"),e=document.getElementById("vnpt-ai-scanner-section"),t=document.getElementById("vnpt-btn-ai-process"),r=document.getElementById("vnpt-btn-raw-process-local"),i=document.getElementById("vnpt-raw-scan-input"),s=document.getElementById("vnpt-ai-queue-container"),a=document.getElementById("vnpt-ai-queue-list"),c=document.getElementById("vnpt-ai-queue-placeholder"),l=document.getElementById("vnpt-btn-show-pdf"),u=document.getElementById("vnpt-btn-clear-queue"),d=document.getElementById("vnpt-pdf-input");if(!n||!e)return;n.addEventListener("click",w=>{w.preventDefault();const x=e.style.display==="none";e.style.display=x?"flex":"none",n.classList.toggle("active",x)});const p=M.get(On);p&&i&&(i.value=p),i&&i.addEventListener("input",()=>{M.setDebounced(On,i.value,1e3)}),l&&l.addEventListener("click",w=>{if(w.preventDefault(),N.lastPdfResults&&N.lastPdfResults.length>0)xf(N.lastPdfResults,N.lastPdfRawText||"",x=>{x.forEach(C=>{ce(C.key,C.value,C.label)}),ke(),F(`✅ Đã cập nhật ${x.length} trường.`)},x=>{try{const C=Js(x);I(C,x,"KẾT QUẢ QUÉT (CẬP NHẬT)")}catch(C){F("❌ Lỗi: "+C.message,"#ef4444")}});else if(i&&i.value.trim()){const x=i.value.trim();try{const C=Js(x);I(C,x,"PHÂN LOẠI DỮ LIỆU THÔ (LOCAL)")}catch(C){F("❌ Lỗi: "+C.message,"#f44336")}}else F("Chưa có nội dung để hiển thị. Vui lòng nhập text hoặc chọn file.","#ffc107")}),u&&u.addEventListener("click",w=>{w.preventDefault(),_T(a,c,i)}),s.addEventListener("click",()=>{d.click()});const y=document.getElementById("vnpt-btn-scan-mail"),A=document.getElementById("vnpt-btn-scan-screen");y&&y.addEventListener("click",async()=>{let w;try{w=GM_getValue(dT,null)}catch{F("❌ Lỗi GM_getValue. Kiểm tra lại grant Tampermonkey.","#ef4444");return}if(!w){F(`⚠️ Chưa có mail nào được gửi!
👉 Mở Gmail/Outlook → chọn email → nhấn nút "📋 Gửi sang VNPT".`,"#f59e0b");return}let x;try{x=typeof w=="string"?JSON.parse(w):w}catch{F("❌ Dữ liệu mail bị lỗi định dạng.","#ef4444");return}const C=30*60*1e3;if(x._timestamp&&Date.now()-x._timestamp>C){F("⚠️ Dữ liệu mail đã quá cũ (>30 phút). Hãy gửi lại từ tab Gmail/Outlook.","#f59e0b");return}const R=`TIÊU ĐỀ: ${x.subject||""}
NGƯỜI GỬI: ${x.sender||""}
...
--- MAIL MỚI ---
${R}`:i.value=R,M.set(On,i.value),F(`📧 Đã nhận mail từ ${x._source||"tab mail"}.`),x.attachmentUrls&&x.attachmentUrls.length>0){F(`📂 Đang tải ${x.attachmentUrls.length} tệp đính kèm...`,"#1a73e8");for(const D of x.attachmentUrls)try{const O=await yT(D.url,D.name);$e.push({file:{name:D.name},...O})}catch(O){console.error("[VNPT] Lỗi tải tệp:",D.name,O)}Sn(a,c),F("✅ Đã nạp xong tệp đính kèm!")}t.click()}),A&&A.addEventListener("click",()=>{const w=mT();w?(i.value.trim()?i.value+=`

--- NỘI DUNG MÀN HÌNH MỚI ---
${w}`:i.value=w,M.set(On,i.value),F("🖥️ Đã quét toàn bộ màn hình."),t.click()):F("⚠️ Không thể quét nội dung màn hình","#ffc107")}),s.addEventListener("dragover",w=>{w.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",w=>{w.preventDefault(),s.classList.remove("drag-over")}),s.addEventListener("drop",async w=>{if(w.preventDefault(),s.classList.remove("drag-over"),w.dataTransfer.files&&w.dataTransfer.files.length>0){for(let x of w.dataTransfer.files){const C=await sc(x);$e.push({file:x,...C})}Sn(a,c)}}),d.addEventListener("change",async w=>{if(w.target.files){for(let x of w.target.files){const C=await sc(x);$e.push({file:x,...C})}w.target.value="",Sn(a,c)}}),window.addEventListener("paste",async w=>{if(e.style.display==="none")return;const x=(w.clipboardData||w.originalEvent.clipboardData).items;let C=!1;for(let D of x)if(D.type.indexOf("image")!==-1||D.type.indexOf("pdf")!==-1){C=!0;const O=D.getAsFile();if(O){const U=await sc(O);$e.push({file:O,...U}),Sn(a,c),F("📋 Đã thêm vào hàng đợi ảnh/file.")}}const R=w.target;C&&(R.tagName==="INPUT"||R.tagName==="TEXTAREA")&&w.preventDefault()});const I=(w,x,C)=>{const R=new Set,D=[],O=["ngày ký","tháng ký","năm ký","số lượng gói","nơi ký","liên hệ a"],U=["ngayKy","ngayKy1","thangKy","thangKy1","namKy","namKy1","soLuongGoi","noiKy"];Object.entries(_e).forEach(([v,m])=>{const _=v.split(",").map(S=>S.trim());if(O.includes(m.toLowerCase())||_.every(S=>U.includes(S))){_.forEach(S=>R.add(S));return}let T="";for(const S of _)if(w[S]){T=w[S],R.add(S);break}D.push({key:v,value:T,label:m,checked:!!T})}),Object.keys(w).forEach(v=>{!R.has(v)&&!U.includes(v)&&w[v]&&D.push({key:v,value:w[v],label:v,checked:!0})}),D.every(v=>!v.value)&&F("⚠️ AI hoặc Regex không trích xuất được thông tin nào!","#ffc107"),N.lastPdfResults=D,N.lastPdfRawText=x||"",xf(D,x||"",v=>{v.forEach(m=>{ce(m.key,m.value,m.label)}),ke(),F(`✅ Đã quét xong ${v.length} trường.`),N.lastPdfResults=N.lastPdfResults.map(m=>{const _=v.find(E=>E.key===m.key);return _?{...m,value:_.value,checked:!0}:{...m,checked:!1}})},v=>{try{const m=Js(v);I(m,v,C),F("🔄 Đã cập nhật lại các trường từ text mới.")}catch(m){F("❌ Lỗi Cập nhật: "+m.message,"#ef4444")}});const H=document.querySelector("#vnpt-pdf-dialog h3");H&&(H.textContent=C)};r.addEventListener("click",()=>{const w=i.value.trim();if(!w){F("⚠️ Vui lòng nhập nội dung văn bản!","#ffc107");return}try{si("Trước khi phân loại Local: "+af());const x=Js(w);I(x,w,"PHÂN LOẠI DỮ LIỆU THÔ (LOCAL)")}catch(x){F("❌ Lỗi: "+x.message,"#f44336")}}),t.addEventListener("click",async()=>{const w=M.get(Fc),x=M.get(Uc)||"gemini-2.5-flash";if(!w){confirm(`Chưa cài đặt Gemini API Key!

AI Scanner yêu cầu mã Google AI Studio.

Nhấn 'OK' để xem hướng dẫn nhé!`)&&window.open("https://github.com/tranchien2000/vnpt-tampermonkey-vite/blob/main/docs/GEMINI_API_GUIDES.md","_blank");return}if($e.length===0&&!i.value.trim()){F("⚠️ Hàng đợi trống. Vui lòng chọn file hoặc dán nội dung","#ffc107");return}i.classList.add("ai-scanning-glow"),t.disabled=!0,t.textContent="⏳ ĐANG QUÉT...";try{si("Trước khi AI Scan: "+af());let C={},R="";if($e.length>0){const D=await cT(null,w,x,null,$e);C=D.fields||{},R=D.rawTextSnippet||D.rawFullText||"",i.value.trim()?i.value+=`

--- KẾT QUẢ ĐỌC FILE ---
${R}`:i.value=R,M.set(On,i.value)}else{const D=i.value.trim();C=await hT(D,w,x),R=D}I(C,R,"PHÂN LOẠI DỮ LIỆU THÔ (AI)"),$e.length>0&&($e=[],Sn(a,c))}catch(C){console.error("Lỗi AI Scan Pipeline:",C),alert(`Lỗi xử lý quét AI:
`+C)}finally{i.classList.remove("ai-scanning-glow"),t.disabled=!1,t.textContent="✨ BẮT ĐẦU QUÉT AI"}})}function f0(){}function fr(n,e=null){return M.get(n,e)}function Zs(n,e){M.set(n,e)}function kf(n,e){if(!e||e.replace(/\D/g,"").length<6)return;let t=fr(n,[]);t=t.filter(r=>r!==e),t.unshift(e),Zs(n,t.slice(0,10))}function eo(n,e){const t=document.getElementById(e);t&&(t.innerHTML=fr(n,[]).map(r=>`<option value="${r}">`).join(""))}function cc(n){return n.toLocaleString("en-US")}function lc(n){return Number(String(n).replace(/[^\d]/g,""))||0}function wT(n){return n.charAt(0).toUpperCase()+n.slice(1)}const li=["","một","hai","ba","bốn","năm","sáu","bảy","tám","chín"];function ET(n){let e=Math.floor(n/100),t=Math.floor(n%100/10),r=n%10,i="";return e>0&&(i+=li[e]+" trăm ",t===0&&r>0&&(i+="lẻ ")),t>1?(i+=li[t]+" mươi ",r===1?i+="mốt":r===5?i+="lăm":r>0&&(i+=li[r])):t===1?(i+="mười ",r===5?i+="lăm":r>0&&(i+=li[r])):r>0&&(e>0&&(i+="lẻ "),i+=li[r]),i.trim()}function TT(n){if(n===0)return"không";const e=["","nghìn","triệu","tỷ"];let t="",r=0;for(;n>0;){const i=n%1e3;i>0&&(t=ET(i)+" "+e[r]+" "+t),n=Math.floor(n/1e3),r++}return t.trim()}function Rf(n,e,t){if(e===""||e===void 0||e===null)return{beforeNum:0,taxNum:0,afterNum:0,beforeStr:"",taxStr:"",afterStr:"",textStr:""};let r=0,i=0,s=0;n==="before"?(r=lc(e),i=t>0?Math.round(r*t):0,s=r+i):n==="tax"?(i=lc(e),r=t>0?Math.round(i/t):0,s=r+i):n==="after"&&(s=lc(e),r=t>0?Math.round(s/(1+t)):s,i=s-r);const a=wT(TT(s))+" đồng";return{beforeNum:r,taxNum:i,afterNum:s,beforeStr:cc(r),taxStr:cc(i),afterStr:cc(s),textStr:a}}function IT(n,e){e.before&&e.before.forEach(t=>ii(t,n.beforeStr)),e.tax&&e.tax.forEach(t=>ii(t,n.taxStr)),e.after&&e.after.forEach(t=>ii(t,n.afterStr)),e.text&&e.text.forEach(t=>ii(t,n.textStr))}function to(n,e=null){try{const t=localStorage.getItem(n);return t!==null?JSON.parse(t):e}catch{return e}}function At(n,e){localStorage.setItem(n,JSON.stringify(e))}function xT(n,e,t,r){let i=to(Vn)??"custom",s=to(pt)??{...Ue},a=to(an)??{},c=to(Ct)??{};const l=document.createElement("div");l.className="cw-tab-header";const u={custom:document.createElement("div"),default:document.createElement("div"),sync:document.createElement("div")};u.custom.innerText="📋 Custom",u.custom.className="cw-tab cw-tab-custom",u.default.innerText="📌 Default",u.default.className="cw-tab cw-tab-default",u.sync.innerText="🔗 Sync",u.sync.className="cw-tab cw-tab-sync";function d(){Object.values(u).forEach(v=>v.classList.remove("active")),u[i].classList.add("active")}d();const p=document.createElement("div");p.style.display=r.data?"none":"block";const y=e("📋 Cấu hình Data","data",v=>{p.style.display=v?"none":"block",t(n)}),A=document.createElement("div");A.className="cw-data-body";function I(){A.innerHTML="";let v=i==="sync"?c:i==="custom"?a:s,m=i==="sync"?Ct:i==="custom"?an:pt;const _=Object.keys(v);_.length===0&&i!=="default"&&(A.innerHTML='<div class="cw-data-empty">Chưa có fields nào.<br>Nhấn [＋ Add] để thêm mới.</div>'),_.forEach(E=>{const T=document.createElement("div");T.className="cw-data-row";let S=i!=="default";const b=v[E],te=b&&typeof b=="object"&&b.hasOwnProperty("value"),ye=te?b.value:b,Zt=te&&b.label||E,He=document.createElement("input");He.type="text",He.value=Zt,He.id=`df-key-${E}`,He.name=`df-key-${E}`,He.className="cw-data-key"+(S?" mutable":""),He.title=E,He.readOnly=!S,S&&(He.onchange=()=>{const De=He.value.trim();if(!De||De===E){He.value=Zt;return}te?v[De]={...b,label:De}:v[De]=ye,delete v[E],At(m,v),I()});const qe=document.createElement("input");if(qe.type="text",qe.value=ye??"",qe.id=`df-val-${E}`,qe.name=`df-val-${E}`,qe.className="cw-data-val",qe.oninput=()=>{te?v[E]={...b,value:qe.value}:v[E]=qe.value,At(m,v)},T.appendChild(He),T.appendChild(qe),S){const De=document.createElement("button");De.innerHTML="✕",De.className="cw-del-btn",De.onclick=()=>{confirm(`Delete "${Zt}"?`)&&(delete v[E],At(m,v),I())},T.appendChild(De)}else T.appendChild(document.createElement("div")).className="cw-pad";A.appendChild(T)})}u.custom.onclick=()=>{i="custom",At(Vn,"custom"),d(),I()},u.default.onclick=()=>{i="default",At(Vn,"default"),d(),I()},u.sync.onclick=()=>{i="sync",At(Vn,"sync"),d(),I()};const w=document.createElement("button");w.innerText="📤",w.className="cw-icon-btn",w.title="Sao lưu toàn bộ dữ liệu ra JSON",w.onclick=()=>sf();const x=document.createElement("button");x.innerText="📥",x.className="cw-icon-btn",x.title="Khôi phục dữ liệu từ JSON";const C=document.createElement("input");C.type="file",C.accept=".json",C.style.display="none",C.onchange=async v=>{v.target.files.length>0&&await of(v.target.files[0])&&setTimeout(()=>location.reload(),1500)},x.onclick=()=>C.click(),p.appendChild(l),l.appendChild(u.custom),l.appendChild(u.default),l.appendChild(u.sync),p.appendChild(A),n.appendChild(y),n.appendChild(p);const R=n.querySelector("#vnpt-cw-fill"),D=n.querySelector("#vnpt-cw-sync"),O=n.querySelector("#vnpt-cw-add"),U=n.querySelector("#vnpt-cw-reset");R&&(R.onclick=tf),D&&(D.onclick=CE),O&&(O.onclick=()=>{i==="default"&&(i="custom",At(Vn,"custom"),d());let v=i==="sync"?c:a,m="new_field_"+Date.now();v[m]="",At(i==="sync"?Ct:an,v),I(),A.scrollTop=A.scrollHeight}),U&&(U.onclick=()=>{confirm("Reset Default Data?")&&(s={...Ue},At(pt,s),I())}),I();const H=y.querySelector(".cw-right-wrap")||document.createElement("div");H.className="cw-right-wrap",H.prepend(w),H.prepend(x),H.appendChild(C),y.appendChild(H)}function AT(n,e,t){let r=Number(localStorage.getItem(Ln))||Zd,i=fr(_r)??{calc:!1,data:!0};function s(w,x){const C=document.createElement("button");return C.innerText=w,C.className="cw-action-btn "+x,C}function a(w,x,C){const R=document.createElement("div");R.className="wg-sec-header";const D=document.createElement("span");D.innerText=w;const O=document.createElement("button");return O.className="wg-toggle-btn",O.innerText=i[x]?"▾":"▴",R.appendChild(D),R.appendChild(O),O.onclick=()=>{i[x]=!i[x],O.innerText=i[x]?"▾":"▴",Zs(_r,i),C(i[x])},R}function c(w){const x=window.innerWidth,C=window.innerHeight,R=w.getBoundingClientRect();w.style.left=Math.min(Math.max(parseFloat(w.style.left),0),x-R.width)+"px",w.style.top=Math.min(Math.max(parseFloat(w.style.top),0),C-36)+"px"}const l=document.createElement("div");if(!e){l.className="cw-title-bar",l.innerHTML='<span class="cw-title-label">VNPT Fast</span>';const w=document.createElement("div");w.className="cw-btn-group";const x={fill:s("Fill","cw-btn-fill"),sync:s("Sync","cw-btn-sync"),add:s("Add","cw-btn-add"),reset:s("↺","cw-btn-reset")};x.sync.onclick=()=>{const C=p("before",d.before.value);y("before",C.beforeStr)},x.reset.title="Reset Default fields",Object.values(x).forEach(C=>w.appendChild(C)),l.appendChild(w),n.appendChild(l)}const u=document.createElement("div");u.className="cw-body-inline",u.innerHTML=`
