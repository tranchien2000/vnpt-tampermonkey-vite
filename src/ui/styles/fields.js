export const fieldsStyles = `
    ...
    .btn-sync-dir:active { transform: scale(0.9); }
    ...
    /* Animation khi thay đổi icon */
    .btn-sync-dir svg { transition: transform 0.3s ease; }
    .btn-sync-dir:active svg { transform: rotate(180deg); }
