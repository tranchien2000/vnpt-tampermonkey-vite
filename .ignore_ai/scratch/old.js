/**
 * @file styles.js
 * @desc Inject to├án bß╗Ö CSS cho cß║ú hai widget v├áo trang bß║▒ng GM_addStyle.
 *       CSS ─æ╞░ß╗úc chia th├ánh c├íc SECTION r├╡ r├áng ─æß╗â dß╗à locate.
 ...
 * @exports injectStyles  ΓÇö gß╗ìi GM_addStyle ─æß╗â inject CSS
...
ba(26, 115, 232, 0.04); margin-bottom: 1px;
        ...
        /* T├¬n file (Control Group ß╗ƒ bottom-row) */
        ...
        /* N├║t Upload File Local (icon-only) */
        .btn-upload-local {
        ...
        /* N├║t Xuß║Ñt TXT trong AI Scanner */
        #vnpt-btn-export-txt {
        ...
        /* H├áng ngang: queue tr├íi + textarea phß║úi */
        ...
        /* Placeholder gß╗ìn nhß║╣, hiß╗çn khi ch╞░a c├│ file */
        ...
        /* Con trß╗Å crosshair khi ß╗ƒ chß║┐ ─æß╗Ö linking */
        .vnpt-linking-mode,
        .vnpt-linking-mode *:not(.vnpt-linking-banner):not(.vnpt-linking-banner *) {
            cursor: crosshair !important;
        }

        /* Hover highlight - xanh d╞░╞íng (element chuß║⌐n bß╗ï ─æ╞░ß╗úc link) */
        .vnpt-link-highlight {
        ...
        /* Existing highlight - xanh l├í (element ─É├â ─æ╞░ß╗úc link) */
        .vnpt-link-existing {
        ...
        /* Unlink hover - ─æß╗Å/cam (hover tr├¬n element ─æ├ú link =Click ─æß╗â Bß╗Ä link) */
        .vnpt-unlink-hover {
        ...
        /* Banner h╞░ß╗¢ng dß║½n nß╗òi ß╗ƒ ─æß║ºu trang */
        .vnpt-linking-banner {
            position: fixed;
            top: 18px;
            left: 50%;
        ...
        /* Badge ─æß║┐m sß╗æ links ─æ├ú chß╗ìn */
